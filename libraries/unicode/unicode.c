...
// See the specification (RFC 2279) for more information about UTF-8. If you are looking for general Unicode information, try out
...
return_type unicode_utf8_to_ucs2(ucs2_type *ucs2, u8 *utf8_string, unsigned int *length)
{
    ...
    else if ((utf8_character & B11100000) == B11000000)
    {
        ...
        *ucs2 = ((utf8_string[1] & B00111111) << 0) +
                ((utf8_character & B00011111) << 6);
        *length = 2;
    }
    else if ((utf8_character & B11110000) == B11100000)
    {
        // A three-byte UTF-8 sequence. Make sure the other bytes are good.
        if ((utf8_string[1] != '\0') &&
            (utf8_string[1] & B11000000) != B10000000 &&
            (utf8_string[2] != '\0') &&
        ...
        *ucs2 = ((utf8_string[2] & B00111111) << 0) +
...
return_type unicode_utf8_to_ucs4(ucs4_type *ucs4, u8 *utf8_string, unsigned int *length)
{
    ...
    else if ((utf8_character & B11100000) == B11000000)
    {
        ...
        *ucs4 = ((utf8_string[1] & B00111111) << 0) +
                ((utf8_character & B00011111) << 6);
        *length = 2;
    }
    else if ((utf8_character & B11110000) == B11100000)
    {
        ...
        *ucs4 = ((utf8_string[2] & B00111111) << 0) +
                ((utf8_string[1] & B00111111) << 6) +
                ((utf8_character & B00001111) << 12);
        *length = 3;
    }
    else if ((utf8_character & B11111000) == B11110000)
    {
        ...
        *ucs4 = ((utf8_string[3] & B00111111) << 0) +
    ...
    else if ((utf8_character & B11111100) == B11111000)
    {
        ...
        *ucs4 = ((utf8_string[4] & B00111111) << 0) +
    ...
    else if ((utf8_character & B11111110) == B11111100)
    {
        ...
        *ucs4 = ((utf8_string[5] & B00111111) << 0) +
...
return_type unicode_utf8_to_ucs4_string(ucs4_type *ucs4_string, u8 *utf8_string, unsigned int max_ucs4_characters)
{
    ...
    // FIXME: Check if we ran out of output space. Likewise in the UCS2 function.
    return UNICODE_RETURN_SUCCESS;
}

// Return the character prior to the character at the given position's length.
unsigned int unicode_utf8_previous_character_length(char *utf8_string, unsigned int string_position)
{
