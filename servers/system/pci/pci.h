// Abstract: Type definitions and function prototypes for the PCI server.
...
// Base addresses specify locations in memory or I/O space.  Decoded size can be determined by writing a value of 0xFFFFFFFF to
// the register, and reading it back.  Only 1 bits are decoded.
// 32 bits.
...
// The PCI interface treats multi-function devices as independent devices.  The slot/function address of each device is encoded in
// a single byte as follows:
//
// Bit 7-3: slot
// Bit 2-0: function
...
typedef struct
{
    ...
    // Pointer to the PCI functions we should use when accessing this bus.
