...
avl_node_type *avl_rotate_right_single(avl_header_type *avl_header, avl_node_type *tree)
{
    ...
    DEBUG_MESSAGE(DEBUG, "node_rotate_left_side_single: called on 0x%x.", tree->start);
    ...
    {
        // Left or right?
        if (((avl_node_type *) node2->parent)->less == (struct avl_node_type *) node2)
        {
            ((avl_node_type *) node2->parent)->less = (struct avl_node_type *) node1;
        }
        else if (((avl_node_type *) node2->parent)->more == (struct avl_node_type *) node2)
        {
            ((avl_node_type *) node2->parent)->more = (struct avl_node_type *) node1;
        }
        else
        {
...
avl_node_type *avl_rotate_left_single(avl_header_type *avl_header, avl_node_type *tree)
{
    char debug_string[MAX_LOG_MESSAGE_LENGTH];
    ...
    DEBUG_MESSAGE(DEBUG, "node_rotate_right_side_single: called on 0x%x.", tree->start);
    ...
    {
        // Left or right?
        if (((avl_node_type *) node1->parent)->less == (struct avl_node_type *) node1)
        {
            // We're the left child of our parent.
            ((avl_node_type *) node1->parent)->less = (struct avl_node_type *) node2;
        }
        else if (((avl_node_type *) node1->parent)->more == (struct avl_node_type *) node1)
        {
            // We're the right child of our parent.
            ((avl_node_type *) node1->parent)->more = (struct avl_node_type *) node2;
        }
        else
        {
...
avl_node_type *avl_rotate_right_double(avl_header_type *avl_header, avl_node_type *tree)
{
    char debug_string[MAX_LOG_MESSAGE_LENGTH];
    ...
    DEBUG_MESSAGE(DEBUG, "node_rotate_left_side_double: called on 0x%x.", tree->start);
    ...
    {
        // Left or right?
        if (((avl_node_type *) node3->parent)->less == (struct avl_node_type *) node3)
        {
            // We're the left child of our parent.
            ((avl_node_type *) node3->parent)->less = (struct avl_node_type *) node2;
        }
        else if (((avl_node_type *) node3->parent)->more == (struct avl_node_type *) node3)
        {
            // We're the right child of our parent.
            ((avl_node_type *) node3->parent)->more = (struct avl_node_type *) node2;
        }
        else
        {
            // We're not our parent's child!
...
avl_node_type *avl_rotate_left_double(avl_header_type *avl_header, avl_node_type *tree)
{
    char debug_string[MAX_LOG_MESSAGE_LENGTH];
    avl_node_type *node1 = tree;
    ...
    DEBUG_MESSAGE(DEBUG, "node_rotate_right_side_double: called on 0x%x.", tree->start);
